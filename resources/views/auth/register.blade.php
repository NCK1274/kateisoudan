...
<!-- メールアドレス記入欄 -->
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror kateisoudan-login-input" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="kateisoudan@kateisoudan.com">
...
<!-- 電話番号記入欄 -->
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control @error('phone') is-invalid @enderror kateisoudan-login-input" name="phone" required placeholder="045-111-0000">
                    </div>
                </div>
...
<!-- パスワード記入欄 -->
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror kateisoudan-login-input" name="password" required autocomplete="new-password">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="password-confirm" type="password" class="form-control kateisoudan-login-input" name="password_confirmation" required autocomplete="new-password">
                    </div>
                </div>
