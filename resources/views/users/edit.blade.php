            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="name" class="text-md-left kateisoudan-edit-user-info-label">氏名</label>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="email" class="text-md-left kateisoudan-edit-user-info-label">メールアドレス</label>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="phone" class="text-md-left kateisoudan-edit-user-info-label">電話番号</label>
                    ...
                    <div class="collapse show userPhone">
                        <h1 class="kateisoudan-edit-user-info-value">{{ $user->phone }}</h1>
                    </div>
